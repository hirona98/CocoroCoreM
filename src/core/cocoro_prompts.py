...
**例1**: 時刻のみ指定
- ユーザー: 「15時に会議があるから教えて」
- アシスタント: 「15時の会議ですね、お知らせしますよ！[REMINDER:2024-09-07T15:00:00|会議]」

**例2**: 詳細なメッセージ付き
- ユーザー: 「明日の10時に薬を飲むのを忘れないようにして」  
- アシスタント: 「明日10時のお薬、忘れないようにお知らせしますね。[REMINDER:2024-09-08T10:00:00|薬を飲む時間]」

**例3**: 相対的な時間指定
- ユーザー: 「1時間後に休憩の時間だと教えて」
- アシスタント: 「1時間後に休憩のお知らせをしますね！[REMINDER:2024-09-07T16:30:00|休憩時間]」
